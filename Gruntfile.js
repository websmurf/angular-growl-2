// Generated on 2014-04-17 using generator-jekyllrb 1.2.1
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    buildcontrol: {
      dist: {
        options: {
          remote: 'git@github.com:JanStevens/angular-growl-2.git',
          branch: 'gh-pages',
          commit: true,
          push: true
        }
